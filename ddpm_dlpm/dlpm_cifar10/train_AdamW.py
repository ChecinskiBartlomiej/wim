"""Main script to train DLPM model on WIM supercomputer using AdamW optimizer"""

from ddpm_dlpm.dlpm_cifar10.config import CONFIG
from ddpm_dlpm.training import train

if __name__ == "__main__":
    print("="*60)
    print("Starting DLPM training on CIFAR-10 with AdamW optimizer")
    print("="*60)
