#!/bin/bash
# LSF batch script to run DDPM multi-GPU training with Adam optimizer on WIM cluster
...
#BSUB -J ddpm_cifar10_adam_multigpu # Job name
...
torchrun --nproc_per_node=8 --nnodes=1 -m ddpm_dlpm_multigpu.ddpm_cifar10.train_Adam
